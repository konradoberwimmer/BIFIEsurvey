...
The dataset `data.pisaNLD` is a data frame with 3992 observations on 405
variables which is a part of the Dutch PISA 2006 data.

## Source

Downloaded from
[doi:10.18637/jss.v020.i05](https://doi.org/10.18637/jss.v020.i05) (Fox,
2007).

## References

Fox, J.-P. (2007). Multilevel IRT Modeling in practice with the package
mlirt. *Journal of Statistical Software, 20*(5), 1-16.
[doi:10.18637/jss.v020.i05](https://doi.org/10.18637/jss.v020.i05)
